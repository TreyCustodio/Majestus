...
class AnimatedMap(Drawable):
    """
    An abstract class that represents
    animated components of the map.
    """
...
class Walls(Drawable):
    """
    The second layer,
    directly above floor.
    """
    def __init__(self, room_dir, prefix = "walls", animate = False, nFrames = 6, fps = 4, tick = 3):
        self.position = vec(0,0)
        self.prefix = prefix
        self.animate = animate
